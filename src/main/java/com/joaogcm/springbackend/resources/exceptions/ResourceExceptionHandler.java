...
import com.joaogcm.springbackend.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError erro = new StandardError(System.currentTimeMillis(), status.value(), "Erro Amazon Service.", e.getMessage(), request.getRequestURI());
